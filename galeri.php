...
<body>
    ...
    <header>
        <div class="container">
        <h1><a href="index.php">SMK Ak Nusa Bangsa</a></h1>
        <ul>
    ...
    <section class="about-container">
                <div class="box">
                    ...
                    <div class="col-4">
                    <img src="foto/<?php echo $p['image']?>" width="70px" height="160px">
    ...
    <!-- footer -->
     <footer>
        <div class="container">
        <small class="huruf"> © Copyright <b>syabila ujikom 2024</b>. All Rights Reserved.</small>
        </div>
    </footer>
</body>
</html>